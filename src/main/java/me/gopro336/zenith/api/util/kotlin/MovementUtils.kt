...
import me.gopro336.zenith.api.util.kotlin.SurroundUtils.flooredPosition
import me.gopro336.zenith.api.util.kotlin.VectorUtils.toVec3d
...
object MovementUtils {
    ...
    fun applySpeedPotionEffects(speed: Double) =
        mc.player.getActivePotionEffect(MobEffects.SPEED)?.let {
