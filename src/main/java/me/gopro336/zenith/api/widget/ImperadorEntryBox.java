package me.gopro336.zenith.api.widget;// package
...
public class ImperadorEntryBox extends Widget {
    ...
    public void center() {
        ...
        this.offsetX = (this.rect.getWidth() / 2f) - (FontUtil.getStringWidth(this.text) / 2f);
    }
    ...
    public void right(float difference) {
        ...
        this.offsetX = this.rect.getWidth() - FontUtil.getStringWidth(this.text) - difference;
    }
    ...
    public float size() {
        ...
        for (int i = 0; i < this.text.length(); i++) {
            ...
            final float w = FontUtil.getStringWidth(c);
